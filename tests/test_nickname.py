...
@pytest.mark.parametrize("nickname, global_name, username, expected", (
...
def test_nicknames(nickname: str | None, global_name: str | None, username: str, expected: hikari.UndefinedNoneOr[str]) -> None:
